    ...
    <>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 bg-white/90 backdrop-blur-sm rounded-3xl overflow-hidden p-6 md:p-10 lg:p-12 border-t-4 border-green-600 shadow-2xl max-w-6xl mx-auto">
            ...
            <div className="text-right flex-1 mt-8 lg:mt-0">
              ...
              <div className="flex gap-6 text-green-600 mb-8">
                {[{ icon: <FaLeaf />, label: 'سوفت سكيب' }, { icon: <FaCogs />, label: 'هارد سكيب' }, { icon: <FaWater />, label: 'أنظمة ري' }].map(({ icon, label }, i) => (
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {qualifications.map((qual, idx) => (
              <div key={idx} className="bg-green-700/50 text-white backdrop-blur-sm p-6 rounded-lg border-r-4 border-green-400 hover:bg-green-700/70 transition duration-300">
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-green-800 to-green-900 text-white text-center">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-lg text-green-100 mb-8">يسعدنا الإجابة على استفساراتكم وتقديم المشورة المتخصصة لمشروعك</p>
          <a
          ...
          <div className="bg-white/95 backdrop-blur-xl max-h-[80vh] overflow-y-auto rounded-3xl shadow-2xl max-w-3xl w-full p-6 border border-green-200 relative">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 mb-6">
              <div className="w-20 h-20 md:w-28 md:h-28 rounded-full overflow-hidden border-4 border-green-600 shadow-lg flex-shrink-0">
                <img src="https://ik.imagekit.io/hussein74/Al%20Amen/owner.jpg?updatedAt=1745446694807" alt="المؤسس" className="w-full object-cover" />
              </div>
              <div className="text-center md:text-right flex-1">
                <Dialog.Title className="text-2xl font-bold text-green-800 mb-2">المهندس أمين حسين</Dialog.Title>
                <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                  <span className="text-green-700 text-sm font-medium bg-green-100 px-3 py-1 rounded-full">مؤسس الشركة</span>
                  <span className="text-green-700 text-sm font-medium bg-green-100 px-3 py-1 rounded-full">خبير تنسيق حدائق</span>
                </div>
              </div>
            </div>

            <Dialog.Description className="text-gray-800 text-lg leading-relaxed space-y-4">
              <p>بخبرة تتجاوز 15 عامًا في مجال اللاندسكيب، قاد المهندس أمين العديد من المشاريع الكبرى التي جمعت بين الإبداع والدقة في التنفيذ. بدأت رحلته مع عالم اللاندسكيب من شغفه الكبير بالطبيعة والمساحات الخضراء.</p>
              ...
              <p>يسعى المهندس أمين دائمًا للتطوير والابتكار في مجال اللاندسكيب، مع التركيز على استخدام أحدث التقنيات والأساليب العالمية لتقديم أفضل النتائج للعملاء.</p>
            </Dialog.Description>
