    ...
    return (
        ...
        >
            ...
            <div className="relative max-w-5xl mx-auto text-center md:text-right space-y-8">
                <h2 className="text-4xl md:text-5xl font-extrabold text-green-800 leading-tight drop-shadow-lg">
                    هل ترغب بتحويل مساحتك الخضراء إلى تحفة فنية؟
                </h2>

                <p className="text-gray-700 text-lg leading-relaxed drop-shadow-md">
                    نقدم خدمات متكاملة في تنسيق الحدائق، الزراعة، والهاردسكيب — من التصميم إلى التنفيذ بأعلى جودة.
                </p>

                {/* قائمة مختصرة بالخدمات */}
                <div className="flex flex-wrap justify-center md:justify-start gap-6 text-green-700">
                ...
                <div>
                    <Link to="/contact">
                        <button className="mt-4 inline-flex items-center gap-2 bg-green-700 text-white px-6 py-3 rounded-2xl hover:bg-green-800 transition shadow-lg">
