...
const StatsSection = () => {
  const stats = [
    { number: 10, label: "مكافآت وجوائز", icon: <FaAward className="text-yellow-300 text-6xl" /> },
    { number: 35, label: "فريق متخصص", icon: <FaUserTie className="text-blue-300 text-6xl" /> },
    { number: 216, label: "عملاء راضون", icon: <FaUsers className="text-green-300 text-6xl" /> },
    { number: 90, label: "حدائق مكتملة", icon: <FaLeaf className="text-lime-300 text-6xl" /> },
  ];
