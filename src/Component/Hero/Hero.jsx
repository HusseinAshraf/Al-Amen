    ...
    <>
      ...
      <section id="home">
        <div className="relative min-h-screen flex items-center justify-center px-4 sm:px-8">
          <div
            className="absolute inset-0 bg-cover bg-center bg-green-900 bg-blend-overlay"
            style={{
              backgroundImage: `url(https://ik.imagekit.io/hussein74/Al%20Amen/background.jpg)`,
            }}
          ></div>
