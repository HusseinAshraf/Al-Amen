  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-12 px-6 py-12 bg-gradient-to-br from-green-100 via-white to-green-50">
      ...
      <div className="text-green-900" dir="rtl">
        <h2 className="text-4xl font-extrabold mb-4 leading-snug text-green-800">
        ...
        <p className="text-lg leading-loose text-green-700">
          مع{" "}
        ...
        <button className="mt-8 px-8 py-3 bg-green-700 text-white font-semibold rounded-full shadow-lg hover:bg-green-800 hover:scale-105 transition duration-300">
           تواصل معنا
        </button>
      </div>
    </section>
